...
8. Criando o Modal para inclusão de transações, pode se utlizar uns prontos como tambem pode ser feito um do zero. nesse projeto sera utilizado um pronto. Comando -> yarn add react-modal se caso houver erro de reconhecimento da função por conta do "TypeScript" e necessario instalar outra dependecia do Modal, ele mesmo sugere qual dependecia instalar! Comando yarn add @types/react-modal.
9. 
